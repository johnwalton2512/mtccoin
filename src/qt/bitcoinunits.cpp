...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MTCC");
    case mBTC: return QString("mMTCC");
    case uBTC: return QString::fromUtf8("μMTCC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("MtcCoins"));
    case mBTC: return QString(QObject::tr("Milli-MtcCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-MtcCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
